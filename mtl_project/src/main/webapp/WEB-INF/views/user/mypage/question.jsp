...
<body>
                                ...
                                <div class="tab-pane fade show active" id="tab-1">
                                    ...
                                    <div class="table-responsive border-0">
                                        <table class="table align-middle p-4 mb-0 table-hover table-shrink">
                                            ...
                                            <tbody class="border-top-0" id="questionList">
                                                <!-- 문의 목록은 여기에 동적으로 추가됨 -->
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div class="tab-pane fade" id="tab-2">
                                    ...
                                    <div class="table-responsive border-0">
                                        <table class="table align-middle p-4 mb-0 table-hover table-shrink">
                                            ...
                                            <tbody class="border-top-0" id="questionList2">
                                                <!-- 문의 목록은 여기에 동적으로 추가됨 -->
                                            </tbody>
                                        </table>
                                    </div>
                        ...
                        <div class="card-body pt-2">
                            <div class="row g-3 g-lg-4">
                                ...
                                <div class="d-flex justify-content-between">
                                    <h6 id="qnaDetailTitle">객실을 추가 예약하고 싶은데 어떻게 하나요?</h6>
                                    <span class="small" id="qnaDetailDate">2024-12-15</span>
                                </div>
                                <p class="space" id="qnaDetailContent">내용을 로드 중...</p>
                                <hr class="mt-3 mb-3">
                                <!-- 답변 -->
                                <div class="d-flex justify-content-between">
                                    <h6>답변</h6>
                                    <span class="small" id="qnaDetailAnswerDate">2024-12-16</span>
                                </div>
                                <p class="space" id="qnaDetailAnswer">답변 내용</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        question.init();  // JavaScript에서 문의 관련 기능 초기화
    </script>
</body>
</html>
