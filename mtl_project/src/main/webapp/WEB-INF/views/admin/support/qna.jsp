	...
	<main>
		...
		<div class="page-content">
			...
			<div class="page-content-wrapper p-xxl-4">
				...
				<div class="row g-4 align-items-center border-bottom">
					...
					<div class="col-lg-6 d-flex justify-content-end">
						<button type="button" class="btn btn-primary-soft"
							data-bs-toggle="modal" data-bs-target="#qnaRegistModal">
				...
				<!-- 질문 수정 모달창 START -->
				<div id="qnaEditModal" class="modal" tabindex="-1" role="dialog">
					<div class="modal-dialog modal-xl modal-dialog-centered" role="document">
						<!-- 제일 큰 모달 -->
						<div class="modal-content">
							<!-- 모달 head -->
					...
					<div class="card-body">
						...
						<div
							...
							<div class="col">
								...
								<a role="button" class="text-primary fw-bold ms-1 mb-0" data-bs-toggle="modal" data-bs-target="#qnaEditModal">우하하</a>
							</div>
