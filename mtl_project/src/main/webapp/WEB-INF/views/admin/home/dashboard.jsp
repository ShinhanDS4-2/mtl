						...
						<div class="d-sm-flex justify-content-between align-items-center">
							...
							<div class="d-grid">
								<a href="#" class="btn btn-primary-soft mb-0"><i
									class="bi bi-plus-lg fa-fw"></i> New Booking</a>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="col-lg-6">
						<div class="card shadow p-3">
							<div class="row g-4">
								<!-- Card img -->
								<div class="col-md-3">
									<img src="assets/images/category/hotel/4by3/10.jpg"
								...
								<div class="col-md-9">
									<div
										...
										<h5 class="card-title mb-0 me-5">
											<a href="hotel-detail.html">Pride moon Village Resort &
												Spa</a>
										</h5>
										...
										<div
											...
											<div class="hstack gap-2 mt-3 mt-sm-0">
												<a href="#" class="btn btn-sm btn-primary-soft px-2 mb-0"><i
													class="bi bi-pencil-square fa-fw"></i></a> <a href="#"
							...
							<div class="row g-4">
								...
								<div class="col-md-9">
									<div
										...
										<!-- Title -->
										<h5 class="card-title mb-0 me-5">
											<a href="hotel-detail.html">Courtyard by Marriott New
												York</a>
										</h5>
										<small><i class="bi bi-geo-alt me-2"></i>258 W jimmy
											Street, New york - 24578</small>
							...
							<div class="row g-4">
								...
								<div class="col-md-9">
									<div
										...
										<!-- Title -->
										<h5 class="card-title mb-0 me-5">
											<a href="hotel-detail.html">Park Plaza Lodge Hotel</a>
										</h5>
										<small><i class="bi bi-geo-alt me-2"></i>31J W Spark
											Street, California - 24578</small>
							...
							<div class="row g-4">
								...
								<div class="col-md-9">
									<div
										...
										<small><i class="bi bi-geo-alt me-2"></i>589 J Wall
				...
				<div class="row g-4">
					...
					<div class="col-xxl-8">
						...
						<div class="card shadow h-100">
							...
							<div class="card-header border-bottom">
								<h5 class="card-header-title mb-1">관광지</h5>
								<span>최근 1년 통계</span>
							</div>
							...
							<div class="card-body">
								...
								<div class="d-flex gap-4 mb-3">
									<h6>
										<span class="fw-light"><i
											class="bi bi-square-fill text-primary"></i> Check-in:</span> 475
										Guests
									</h6>
									<h6>
										<span class="fw-light"><i
											class="bi bi-square-fill text-info"></i> Check-out:</span> 157
										Guests
									</h6>
								</div>
								<!-- Apex chart -->
					...
					<div class="col-lg-6 col-xxl-4">
						<div class="card shadow h-100">
							<!-- Card header -->
							<div class="card-header border-bottom">
								<h5 class="card-header-title">예약</h5>
								<span>이번 달 예약 현황</span>
							</div>
								...
								<ul class="list-group list-group-borderless mb-0">
									<li class="list-group-item d-flex justify-content-between">
										<span class="h6 fw-light mb-0"><i
											class="text-success fas fa-circle me-2"></i> 예약</span> <span
										class="h6 fw-light mb-0">200 Rooms</span>
									</li>
									<li class="list-group-item d-flex justify-content-between">
										<span class="h6 fw-light mb-0"><i
											class="text-danger fas fa-circle me-2"></i> 예약 취소</span> <span
										class="h6 fw-light mb-0">245 Rooms</span>
									</li>
								</ul>
							</div>
						</div>
									...
									<div class="d-sm-flex align-items-center mb-1 mb-sm-0">
										...
										<div class="ms-sm-3 mt-2 mt-sm-0">
											...
											<ul class="nav nav-divider small">
												...
												<li class="nav-item"><span class="text-danger">Booking
														cancel</span></li>
											</ul>
										</div>
									</div>
