const userNotice = (function () {
    ...
    function loadNotices(curPage = 1) {
        ...
        $.ajax({
            url: "/mtl/api/notice/partner/list",
            method: "POST",
    ...
    function renderNotices(notices) {
        ...
        notices.forEach(notice => {
            const row = $(`
                <tr>
					<td> <h6 class="text-primary fw-bold ms-1 mb-0"><a href="#" data-bs-toggle="modal" data-bs-target="#noticeModal">${notice.title}</a></h6> </td>
					<td class="text-end"> <h6 class="ms-1 mb-0 fw-normal">${notice.create_date_format}</h6> </td>
				</tr>
            `);
